...
For now WooCommerce and Shopify.
...
Yes this is a good suggestion but we will rapidly add more insights.
...
For now a single-page dashboard, that can be long like a multipage report.
